...
def isValidWord(word, hand, wordList):
    ...
    if word in wordList:
        for letter in word:
            if letter in temp.keys() and temp[letter]>0:
                flag = True
                temp[letter] -= 1
            else:
                flag = False
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while length>0:
        ...
        if word=='.':
            ...
            if isValidWord(word, temp, wordList) == False:
                print ("Invalid word, please try again.")
                print()
            else:
                score = getWordScore(word, n)
                total += score
                print ('"{}"'.format(word) + " earned " + str(score) + " points. Total: " + str(total) + " points")
                print()
