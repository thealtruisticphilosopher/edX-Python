...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(len(lowercase)):
            if i+shift<=25:
                cipher[lowercase[i]] = lowercase[i+shift]
                cipher[uppercase[i]] = uppercase[i+shift]
            else:
                cipher[lowercase[i]] = lowercase[i+shift-26]
                cipher[uppercase[i]] = uppercase[i+shift-26]
        return cipher
...
def decrypt_story():
    ...
    dec_story = CiphertextMessage(enc_story)
